...
# YouTube API key
api_key = 'AIzaSyCNd0lhic6aHCVTBHk5QMPmZT06OmAJRCA'
    ...
    for video_id in video_ids:
        try:
            ...
            if "commentsDisabled" in error_message:
                ...
                print(f"An error occurred for video ID: {video_id}, Error: {error_message}")
...
def main():
    ...
    with st.sidebar:
        choice = option_menu(None, ["Home","Loading Data to MongoDB","SQL Data Warehouse","Channel Insights and Data Visualization"], 
    ...
    if choice == "Home":
        ...
        st.write("YouTube is the world's most popular video-sharing platform, with over 2 billion active users. It is a valuable source of data for businesses, researchers, and individuals. This project will demonstrate how to harvest and warehouse YouTube data using SQL, MongoDB, and Streamlit")
        st.write("[:open_book: Learn More  >](https://en.wikipedia.org/wiki/YouTube)")
        st.write("## :blue[Advantages]")
        st.write("A. This strategy facilitates the acquisition of extensive datasets from YouTube, providing the versatility to store information using diverse mechanisms like MongoDB and SQL.") 
        st.write("B. This data is amenable to analysis across an array of tools, Streamlit included. This methodology enables trend identification, predictive analytics, and enhanced decision-making capabilities")
    ...
    if choice=="Channel Insights and Data Visualization":
